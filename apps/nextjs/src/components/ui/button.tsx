...
export const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-[.60]",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        lg: "h-16 rounded-lg px-8 text-xl font-sundry-narrow-bold",
      },
      iconOnly: {
        true: "",
        false: "",
