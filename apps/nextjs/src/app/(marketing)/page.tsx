                ...
                >
                  ...
                  <div className="flex-1 bg-secondary p-8 overflow-y-auto">
                    <h3 className="font-sundry-narrow-bold text-3xl md:text-5xl text-primary font-bold mb-4">
                      ...
                      {i % 4 === 1 && (
                        <>
                          Goodbye writer's block, hello <span className="underline-offset">auto-generated drafts</span>
                        </>
                      )}
                      {i % 4 === 2 && (
                        <>
                          Your best replies become the new standard with <span className="underline-offset">FAQs</span>
                        </>
                      )}
                      {i % 4 === 3 && (
                        <>
