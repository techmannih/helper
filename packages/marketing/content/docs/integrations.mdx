...
1. Under "Event Subscriptions", add `https://<your-helper-domain>/api/webhooks/slack/event` as the event request URL
1. Also under "Event Subscriptions", subscribe to the following bot events:
   ...
   - `message.im`
   - `tokens_revoked`
1. Under "Interactivity & Shortcuts", add `https://<your-helper-domain>/api/webhooks/slack/response` as the interactivity request URL
