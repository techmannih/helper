...
Helper authenticates requests to your endpoint using HMAC-SHA256. We recommend you verify the request is legitimate by generating the same HMAC signature on your server and checking it matches the header.
